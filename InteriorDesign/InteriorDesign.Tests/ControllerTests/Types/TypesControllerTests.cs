...
namespace InteriorDesign.Tests.ControllerTests.TypesControllerTests
{
    public class TypesControllerTests
    {
        ...
        [Fact]
        public async Task ShelfReturnsRedirectResultToApplicationError()
        {
            var controller = new TypesController(
                service.Object,
                logger.Object,
            ...
            var result = await controller.Shelf();
        ...
        [Fact]
        public async Task ShelfReturnsViewResultWhenGetModelFromCache()
        {
            cache.Setup(x => x.TryGetValue(It.IsAny<object>(), out testModel))
                .Returns(true);
