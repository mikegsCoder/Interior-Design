...
namespace InteriorDesign.Tests.ControllerTests.ModelsControllerTests
{
    public class ModelsControllerTests
    {
        ...
        [Fact]
        public async Task YoungRoom_Wardrobe_ReturnsRedirectResultToApplicationError()
        {
            var controller = new ModelsController(
                service.Object,
                logger.Object,
            ...
            var result = await controller.YoungRoom_Wardrobe();
        ...
        [Fact]
        public async Task YoungRoom_Wardrobe_ReturnsViewResultWhenGetModelFromCache()
        {
            cache.Setup(x => x.TryGetValue(It.IsAny<object>(), out testModel))
                .Returns(true);
