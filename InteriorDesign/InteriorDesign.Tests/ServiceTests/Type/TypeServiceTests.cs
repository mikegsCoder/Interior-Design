...
namespace InteriorDesign.Tests.ServiceTests.Type
{
    public class TypeServiceTests
    {
        ...
        [Fact]
        public async Task GetTypesInfoAsyncReturnsListOfTypeViewModel()
        {
            ...
            expected.Add(new TypeViewModel()
            {
                Name = bed.Name,
            ...
            var actual = await service.GetTypesInfoAsync();
        ...
        [Fact]
        public async Task GetTypesInfoAsyncReturnsEmptyListOfTypeViewModel()
        {
            var optionsBuilder = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(Guid.NewGuid().ToString());
        ...
        [Fact]
        public async Task GetCategoriesByTypeInfoAsyncReturnsListOfCategoryTypeViewModel()
        {
            var optionsBuilder = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(Guid.NewGuid().ToString());
            ...
            var actual = await service.GetCategoriesByTypeInfoAsync("Bed");
        ...
        [Fact]
        public async Task GetCategoriesByTypeInfoAsyncReturnsEmptyListOfCategoryTypeViewModel()
        {
            var optionsBuilder = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(Guid.NewGuid().ToString());
